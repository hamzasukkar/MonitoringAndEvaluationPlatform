...
namespace MonitoringAndEvaluationPlatform.Controllers
{
    public class LogicalFrameworksController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var logicalFramework = await _context.LogicalFramework.Include(lf=>lf.logicalFrameworkIndicators)
        ...
        {
            ViewData["ProjectName"] = new SelectList(_context.Projects, "ProjectID", "ProjectName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Code,Name,Type,Trend,IndicatorsPerformance,ProjectID")] LogicalFramework logicalFramework)
        {
            if (ModelState.IsValid)
            {
                _context.Add(logicalFramework);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Code,Name,Type,Trend,IndicatorsPerformance,ProjectID")] LogicalFramework logicalFramework)
        {
