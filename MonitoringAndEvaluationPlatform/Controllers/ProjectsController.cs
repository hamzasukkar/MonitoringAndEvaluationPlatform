...
namespace MonitoringAndEvaluationPlatform.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.MinistryList = new SelectList(ministries, "Code", isArabic ? "MinistryDisplayName_AR" : "MinistryDisplayName_EN");
        ...
        private async Task PopulateCreateViewBagAsync(List<string> selectedSectorCodes = null, List<string> selectedDonorCodes = null, List<int> selectedIndicators = null, string locationSelections = null, string donorFundingBreakdown = null)
        {
            ...
            ViewBag.MinistryList = new SelectList(_context.Ministries, "Code", isArabic ? "MinistryDisplayName_AR" : "MinistryDisplayName_EN");
