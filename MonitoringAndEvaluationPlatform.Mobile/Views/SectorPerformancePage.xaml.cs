...
{
    public partial class SectorPerformancePage : ContentPage
    {
        private readonly CategoryPerformanceViewModel _viewModel;

        public SectorPerformancePage(ApiService apiService)
        {
            InitializeComponent();
            _viewModel = new CategoryPerformanceViewModel(apiService, "Sector");
